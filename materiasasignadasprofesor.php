...
<html>
    ...
    <div class="container materiasprofe">
        <div class="row caja_bienvenido">	
         ...
         <div class="col l6 animacion actividades materias">
          ...
          <div class="row vistarapida">
            <div class="row cajas">
            <?php 
                  $sql= "SELECT Ma.*, U.id FROM `materias` AS Ma INNER JOIN `usuarios` AS U ON U.id=Id_profesor WHERE  Id_profesor='$_SESSION[Id]'";
                  $result = $conn->query($sql);
                ...
                while($row = $result->fetch_assoc()){
                 ...
                 <li>
                  ...
                  <div class='collapsible-body'>
                    <div class='iconos'>
                      <a href='".$row["Direccion_actividades"]."?var=".$row["Id_materia"]."'>
                    ...
                    <div class='iconos'>
                      <a  href='".$row["Direccion_notas"]."?var=".$row["Id_materia"]."'>
